...
const content = {
  pl: {
    ...
    controllerText: "Administratorem danych osobowych jest ANM Collective Sp. z o.o.",
  ...
  en: {
    ...
    controllerText:
      "The controller of personal data is ANM Collective Sp. z o.o.",
    ...
    revokeMeta:
      "You can revoke application access in Facebook settings:",
    ...
    revokeGoogle:
      "You can revoke application access in Google security settings:",
    ...
    >
      ...
      <section className="card">
        ...
        <div className="footer-links" aria-label="Important ANM ContentIQ links">
          <a href={company.appUrl}>{t.labels.home}</a>
