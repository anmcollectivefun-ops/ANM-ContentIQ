    ...
    <main className="min-h-screen bg-[#070816] text-white">
      ...
      <header className="border-b border-white/10">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          <Link href="/" className="rounded-full border border-white/10 px-5 py-2 text-sm text-white/70 hover:bg-white/10">
            Landing page
          </Link>
        </div>
      </header>
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <h1 className="mt-3 text-4xl font-black">Twoje projekty contentowe</h1>
          <p className="mt-3 max-w-2xl text-white/60">
            Wybierz projekt, markę albo przestrzeń roboczą, aby przejść do właściwej aplikacji ANM ContentIQ.
          </p>
        </div>
          ...
          {workspaces.map((workspace) => (
            ...
            >
              <div className="mb-8 flex items-center justify-between">
                ...
                <span className="text-sm text-white/40 group-hover:text-white">Otwórz →</span>
              </div>
              ...
              <div className="mt-6 rounded-2xl bg-white/[0.05] p-4">
                ...
                <p className="mt-1 text-2xl font-black text-cyan-300">{workspace.score}</p>
              </div>
            </Link>
          ))}
        </div>
